...
inline				vert() {}
inline				vert(const vert &v) : _texture(v.texture()), _world(v.world()), _screen(v.screen()), _normal(v.normal()) {}
...
inline	const	point4		&normal() const	{return _normal;}
inline		point4		&normal()	{return _normal;}
